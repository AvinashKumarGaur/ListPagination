...
data class Items (
  ...
  /*fun updateOwnerJson() {
    ownerJson = Gson().toJson(owner)
  }

  fun updateLicenseJson() {
    //licenseJson = Gson().toJson(license)
  }
...
*/
 /* fun parseLicenseJson() {
    license = Gson().fromJson(licenseJson, License::class.java)
  }*/
}